<div>
    <div class="page-header d-flex justify-content-between align-items-center border-bottom mb-3">
        <div>
                ...
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            <strong>Price:</strong> RS {{ number_format($item->price, 2) }}<br>
                    ...
                    <div class="card-footer d-flex justify-content-between">
                        ...
                        <div>
                            <button class="btn btn-sm btn-danger" wire:click="delete({{ $item->id }})" onclick="confirm('Are you sure?') || event.stopImmediatePropagation()">
