...
class Analytics extends Component
{
    ...
    public $branches = []; // List of branches for dropdown
    ...
    {
        // Load active branches for the filter
    ...
    public function loadAnalytics()
    {
        ...
        match ($this->timeFilter) {
            ...
            'all' => null,
            default => $query->whereBetween('placed_at', [now()->subDays(7), now()]),
        };
    ...
    public function render()
    {
        return view('livewire.admin.analytics', [
            'branches' => $this->branches, // Pass branches to the view
        ]);
    }
}
